...
{
    int twentiesInTill = cashTill[3] + twenties;
    int tensInTill = cashTill[2] + tens;
    int fivesInTill = cashTill[1] = fives;
    int onesInTill = cashTill[0] = ones;
    ...
    while ((changeNeeded > 19) && (twentiesInTill > 0))
    {
        twentiesInTill--;
        changeNeeded -= 20;
    ...
    while ((changeNeeded > 9) && (tensInTill > 0))
    {
        tensInTill--;
        changeNeeded -= 10;
    ...
    while ((changeNeeded > 4) && (fivesInTill > 0))
    {
        fivesInTill--;
        changeNeeded -= 5;
    ...
    while ((changeNeeded > 0) && (onesInTill > 0))
    {
        onesInTill--;
        changeNeeded -= 1;
    ...
    cashTill[0] = onesInTill;
    cashTill[1] = fivesInTill;
    cashTill[2] = tensInTill;
    cashTill[3] = twentiesInTill;
}
